...
new BuiltInFunction(".cache_class",R_do_cache_data_class,1,	1,	2,	{PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("bitwiseNot",	do_bitwise_not,	2,	11,	1,	{PP_FUNCALL, PREC_FN,	0}),
...
new BuiltInFunction("unserialize",	do_unserialize,	2,	11,	2,	{PP_FUNCALL, PREC_FN,	0}),
